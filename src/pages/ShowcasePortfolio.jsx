  ...
  return (
    <svg width="100%" height="100%" viewBox="0 0 400 300" preserveAspectRatio="xMidYMid slice">
      ...
      {[0,30,60,90,120,150].map(a => {
        ...
        return <line key={a} x1={200} y1={150} x2={200 + 160 * Math.cos(r)} y2={150 + 160 * Math.sin(r)} stroke="color-mix(in srgb, var(--cs-violet) 75%, white)" strokeWidth="0.6" opacity="0.5"/>
      })}
      <circle cx="200" cy="150" r="80" fill="none" stroke="var(--cs-violet)" strokeWidth="1.5"/>
      <circle cx="200" cy="150" r="50" fill="var(--cs-violet)" opacity="0.2"/>
      <circle cx="200" cy="150" r="20" fill="var(--cs-lime)" opacity="0.6"/>
      ...
      {Array.from({length: 6}).map((_, i) =>
        Array.from({length: 4}).map((_, j) => (
          <rect key={`${i}-${j}`} x={30 + i * 60} y={30 + j * 65} width={45} height={50} rx="4"
            fill="var(--cs-violet)" opacity={0.1 + (i + j) * 0.04}/>
        ))
      )}
    ...
    <svg width="100%" height="100%" viewBox="0 0 400 300" preserveAspectRatio="xMidYMid slice">
      ...
      <defs>
        <radialGradient id="ai3g1" cx="30%" cy="30%" r="50%">
          <stop offset="0%" stopColor="var(--cs-lime)" stopOpacity="0.5"/>
          <stop offset="100%" stopColor="transparent"/>
        </radialGradient>
        <radialGradient id="ai3g2" cx="70%" cy="70%" r="50%">
          <stop offset="0%" stopColor="var(--cs-violet)" stopOpacity="0.5"/>
          <stop offset="100%" stopColor="transparent"/>
        </radialGradient>
      </defs>
...
function ArtworkAI4() {
  return (
    <svg width="100%" height="100%" viewBox="0 0 400 300" preserveAspectRatio="xMidYMid slice">
      <rect width="400" height="300" fill="var(--cs-ink)"/>
      {Array.from({length: 12}).map((_, i) => (
        <path key={i}
          d={`M ${200 + 120*Math.cos(i*30*Math.PI/180)} ${150 + 100*Math.sin(i*30*Math.PI/180)} L 200 150`}
          stroke="var(--cs-violet)" strokeWidth="0.8" opacity="0.4"/>
      ))}
      <circle cx="200" cy="150" r="60" fill="var(--cs-violet)" opacity="0.12"/>
      <circle cx="200" cy="150" r="30" fill="var(--cs-violet)" opacity="0.25"/>
      <circle cx="200" cy="150" r="8" fill="var(--cs-lime)"/>
...
function ArtworkNonAI1() {
  return (
    <svg width="100%" height="100%" viewBox="0 0 400 300" preserveAspectRatio="xMidYMid slice">
      ...
      <rect x="60" y="40" width="280" height="200" fill="none" stroke="var(--cs-ink)" strokeWidth="1.5"/>
      <rect x="70" y="50" width="260" height="180" fill="none" stroke="#C8C2B8" strokeWidth="0.8"/>
      <circle cx="200" cy="130" r="60" fill="none" stroke="var(--cs-ink)" strokeWidth="1.5"/>
      <line x1="140" y1="130" x2="260" y2="130" stroke="var(--cs-ink)" strokeWidth="1"/>
      <line x1="200" y1="70" x2="200" y2="190" stroke="var(--cs-ink)" strokeWidth="1"/>
      <text x="200" y="210" textAnchor="middle" fontSize="12" fontFamily="Fraunces,Georgia,serif" fill="var(--cs-ink)">Typographic Study</text>
      <text x="200" y="226" textAnchor="middle" fontSize="8" fontFamily="Inter" fill="var(--cs-soft)" letterSpacing="3">HANDCRAFTED · NO AI</text>
    </svg>
  )
}
function ArtworkNonAI2() {
  return (
    <svg width="100%" height="100%" viewBox="0 0 400 300" preserveAspectRatio="xMidYMid slice">
      ...
      <text x="60" y="120" fontSize="72" fontFamily="Fraunces,Georgia,serif" fill="var(--cs-ink)" fontWeight="300">حرف</text>
      <text x="60" y="170" fontSize="14" fontFamily="Inter" fill="var(--cs-soft)" letterSpacing="2">ARABIC LETTERING</text>
      <text x="60" y="190" fontSize="11" fontFamily="Inter" fill="var(--cs-soft)">Hand-drawn, digitised</text>
      <line x1="60" y1="200" x2="340" y2="200" stroke="var(--cs-hairline)" strokeWidth="1"/>
      <text x="60" y="220" fontSize="9" fontFamily="Inter" fill="var(--cs-soft)" letterSpacing="4">NO AI ASSISTANCE</text>
    </svg>
  )
}
function ArtworkNonAI3() {
  return (
    <svg width="100%" height="100%" viewBox="0 0 400 300" preserveAspectRatio="xMidYMid slice">
      ...
      <circle cx="200" cy="140" r="80" fill="none" stroke="var(--cs-ink)" strokeWidth="1.5"/>
      <circle cx="200" cy="140" r="55" fill="none" stroke="var(--cs-ink)" strokeWidth="1"/>
      {[0,45,90,135,180,225,270,315].map(a => {
        const r = (a * Math.PI)/180
        return <line key={a} x1={200 + 55*Math.cos(r)} y1={140 + 55*Math.sin(r)}
          x2={200 + 80*Math.cos(r)} y2={140 + 80*Math.sin(r)}
          stroke="var(--cs-ink)" strokeWidth="1.2"/>
      })}
      <circle cx="200" cy="140" r="18" fill="var(--cs-ink)"/>
      <text x="200" y="245" textAnchor="middle" fontSize="10" fontFamily="Inter" fill="var(--cs-soft)" letterSpacing="3">DILMUN MOTIF · TRADITIONAL</text>
    </svg>
  )
}
function ArtworkNonAI4() {
  return (
    <svg width="100%" height="100%" viewBox="0 0 400 300" preserveAspectRatio="xMidYMid slice">
      ...
      <rect x="50" y="50" width="300" height="200" fill="var(--cs-ink)"/>
      ...
      <text x="200" y="228" textAnchor="middle" fontSize="8" fontFamily="Inter" fill="var(--cs-soft)" letterSpacing="3">MANUAL ILLUSTRATION</text>
    </svg>
  )
}
...
export default function ShowcasePortfolio() {
  ...
  return (
    <div className="max-w-screen-xl mx-auto px-6 py-16">
      <Reveal>
        <p className="text-[10px] tracking-[0.2em] uppercase font-medium mb-3" style={{ color: 'var(--cs-violet)' }}>SHOWCASE PORTFOLIO</p>
      ...
      <Reveal delay={80}>
        <div
          ...
          style={{ background: '#F0EDE7', border: '1px solid var(--cs-hairline)' }}
        >
          {[
            ...
            <button
              ...
              style={{
                background: filter === f.key ? 'var(--cs-violet)' : 'transparent',
                color: filter === f.key ? 'white' : 'var(--cs-soft)',
              }}
            >
              {f.label}
            </button>
      ...
      {/* Count */}
      <Reveal delay={100}>
        <p className="mt-4 text-xs" style={{ color: 'var(--cs-soft)' }}>
            ...
            >
              ...
              >
                ...
                <div className="relative overflow-hidden" style={{ height: 200 }}>
                  ...
                  <div className="absolute top-3 left-3">
                    <span
                      ...
                      style={{
                        background: work.type === 'ai' ? 'color-mix(in srgb, var(--cs-violet) 85%, transparent)' : 'rgba(20,20,26,0.75)',
                        color: 'white',
                      }}
                    >
                ...
                <div className="p-4">
                  ...
                  <p className="text-[11px]" style={{ color: 'var(--cs-soft)' }}>
      ...
      <Reveal delay={100}>
        ...
        >
          <p className="text-[10px] tracking-[0.2em] uppercase font-medium mb-3" style={{ color: 'color-mix(in srgb, var(--cs-violet) 75%, white)' }}>
